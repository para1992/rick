...
from seedflow_cli.engine import CandidateValidationError, WorkflowBudgetExceeded, WorkflowEngine
from seedflow_cli.llm import LLMClient, MockLLMClient
from seedflow_cli.logger import JsonRunStore, MarkdownStepLogger
from seedflow_cli.parser import parse_program
from seedflow_cli.security import SecurityOptions
...
class EngineTests(unittest.TestCase):
    ...
    def test_omitted_judge_uses_runtime_random_selection_policy(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch("seedflow_cli.engine.secrets.token_hex", return_value="0" * 31 + "1"):
                state = engine.run(program)
