...
class LLMTests(unittest.TestCase):
    ...
    def test_response_format_routes_known_internal_prompts_to_schemas(self) -> None:
        ...
        self.assertEqual(judge_format["json_schema"]["name"], "rick_judge")
        self.assertEqual(candidate_format["json_schema"]["name"], "rick_candidate")
        self.assertEqual(dod_format["json_schema"]["name"], "rick_dod")
    ...
    def test_openrouter_retries_rate_limit_then_returns_content(self) -> None:
        ...
        with patch(
            "rick_cli.llm.urllib.request.urlopen",
            side_effect=[
    ...
    def test_openrouter_reports_unsupported_json_mode_guidance(self) -> None:
        ...
        with patch("rick_cli.llm.urllib.request.urlopen", side_effect=http_error(400, "Bad Request", body)):
    ...
    def test_chat_seeded_json_does_not_send_response_format(self) -> None:
        ...
        with patch("rick_cli.llm.urllib.request.urlopen", return_value=response) as urlopen:
    ...
    def test_openrouter_reports_non_json_success_response(self) -> None:
        ...
        with patch("rick_cli.llm.urllib.request.urlopen", return_value=FakeResponse("<html>bad gateway</html>")):
    ...
    def test_openrouter_reports_missing_content_shape(self) -> None:
        ...
        with patch("rick_cli.llm.urllib.request.urlopen", return_value=FakeResponse('{"choices":[]}')):
